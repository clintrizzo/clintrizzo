...
<br></br>
- Currently studying Cypress to learn more end to end testing for future projects and continued learning. Building a task management using Angular and will then be bringing in cypress to test an angular project.
<br></br>
